...
.. autoclass:: lgrez.features.special.Special
    ...
    .. include:: cognote.rst
    - :Commande ``!panik`` (alias ``!kill``) : .. automethod:: lgrez.features.special.Special.panik.callback
    - :Commande ``!do`` : .. automethod:: lgrez.features.special.Special.do.callback
    - :Commande ``!shell`` : .. automethod:: lgrez.features.special.Special.shell.callback
    - :Commande ``!co`` : .. automethod:: lgrez.features.special.Special.co.callback
    - :Commande ``!doas`` : .. automethod:: lgrez.features.special.Special.doas.callback
    - :Commande ``!secret`` (alias ``!autodestruct``, ``!ad``) : .. automethod:: lgrez.features.special.Special.secret.callback
    - :Commande ``!stop`` : .. automethod:: lgrez.features.special.Special.stop.callback
    - :Commande ``!help`` (alias ``!aide``, ``!aled``, ``!oskour``) : .. automethod:: lgrez.features.special.Special.help.callback
...
.. automodule:: lgrez.blocs.bdd.model
   :members:
   :member-order: bysource
