...
.. autoclass:: lgrez.features.actions_publiques.ActionsPubliques
    ...
    - :Commande ``!plot`` : .. automethod:: lgrez.features.actions_publiques.ActionsPubliques.plot.callback
...
.. autoclass:: lgrez.features.annexe.Annexe
    ...
    - :Commande ``!send`` (alias ``!tell``) : .. automethod:: lgrez.features.annexe.Annexe.send.callback
    - :Commande ``!embed`` : .. automethod:: lgrez.features.annexe.Annexe.embed.callback
...
.. automodule:: lgrez.features.remplissage_bdd
   :members:
   :exclude-members: RemplissageBDD
   :member-order: bysource

.. --autocog--:lgrez.features.remplissage_bdd.RemplissageBDD: {
.. (this bloc is autogenerated each time docs are build, don't change manually! See end of conf.py)
.. autoclass:: lgrez.features.remplissage_bdd.RemplissageBDD
    :members:

    .. include:: cognote.rst
    - :Commande ``!droptable`` : .. automethod:: lgrez.features.remplissage_bdd.RemplissageBDD.droptable.callback
    - :Commande ``!fillroles`` : .. automethod:: lgrez.features.remplissage_bdd.RemplissageBDD.fillroles.callback
